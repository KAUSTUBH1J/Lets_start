    ...
    render(){
        ...
        return(
            <>
                ...
                <span class="badge position-absolute top-0  translate-middle text-bg-danger" style={{left: '97%', zIndex: '2'}}>{source?source:'Unkown'}</span>
                    ...
                    <div className="card-body"> 
                        ...
                        <p class="card-text"><small class="text-body-secondary">Author {!Author ?'Unkonw': Author} publishedAt {new Date(publishedAt).toUTCString()}</small></p>
